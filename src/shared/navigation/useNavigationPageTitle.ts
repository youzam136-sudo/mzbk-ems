...
const routeTitleFallbacks: Record<string, string> = {
  ...
  '/monitoring/grid': '기저발전',
  '/monitoring/base/plant': '기저전력 개별 운전현황',
  '/monitoring/base/total': '기저전력 통합 운전현황',
  '/monitoring/ess': '디젤발전',
  '/monitoring/assist': '보조전력 운전현황',
  '/monitoring/diesel1': '디젤발전',
  '/monitoring/diesel2': '디젤발전',
  '/monitoring/pcs': '충방전현황',
  '/monitoring/battery': '충방전현황',
  '/monitoring/standby': '예비전력 운전현황',
  '/monitoring/ac': '공조기현황',
  '/monitoring/dispatch': '현황정보',
  ...
  '/history/grid': '기저발전 이력',
  '/history/ess': '디젤발전 이력',
  '/history/pcs': '충방전 이력',
  '/history/battery': '충방전 이력',
  '/history/diesel1': '디젤발전 이력',
  '/history/diesel2': '디젤발전 이력',
  '/history/ac': '공조기 이력',
  '/history/power-consumption': '전력소비 이력',
  '/history/grid-base-generation-history': '기저발전 이력',
  '/history/support-generation-history': '디젤발전 이력',
  '/history/pcs-charge-discharge-history': '충방전 이력',
