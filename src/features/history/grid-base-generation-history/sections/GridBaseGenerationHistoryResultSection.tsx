  ...
  return (
    <>
      <PageCard className="grid-base-history-result grid-base-history-result--chart">
        <div className="grid-base-history-result__summary-chips">
          {data.summary.columns.map((column, columnIndex) => (
            <div className="grid-base-history-result__stat-row" key={column}>
              <span className="grid-base-history-result__stat-label">{column}</span>
              <StatChipGroup
                ariaLabel={`${column} 요약`}
